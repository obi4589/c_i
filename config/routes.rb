CI::Application.routes.draw do
  ...
  resources :activities do
    collection do
      get :me, :suggestions, :nearby, :redir_email_updates, :redir_email_settings, :redir_new_event
    end
  end
  ...
  resources :philanthropists do
    member do
      get :home, :followers, :following, :history, :change_password, :email_settings, :data
  ...
  resources :charities do
    member do
      get :home, :followers, :following, :about, :history, :change_password, :email_settings, :data
      patch :active, :no_avatar, :update_password, :update_emails
    end
    collection do
      get :follow
